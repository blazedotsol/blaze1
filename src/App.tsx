    ...
    <div className="bg-black">
      ...
      >
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-white handdrawn-heading text-2xl md:text-4xl lg:text-5xl uppercase tracking-widest text-center mb-16 border-b border-white pb-4">
            SUBMIT YOUR APPLICATION
          </h2>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Block 1: Get your Job Application */}
            <div className="handdrawn-border handdrawn-box p-6 bg-white">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-black handdrawn-text text-lg">{">"}</span>
                <h3 className="text-black handdrawn-text text-lg uppercase tracking-wider">get your job application</h3>
              </div>
              
              <p className="text-gray-700 mb-6 text-sm handdrawn-text">upload an image and make the figure hold a job application!</p>
              
              <div className="space-y-4">
                <div>
                  <label className="block text-black handdrawn-text text-sm mb-2 uppercase tracking-wider">upload image:</label>
                  <input
                    type="file"
                    accept="image/*"
                    onChange={handleImageUpload1}
                    className="w-full bg-gray-100 handdrawn-input text-black p-3 focus:border-gray-500 focus:outline-none file:bg-black file:text-white file:border-none file:px-4 file:py-2 file:mr-4 handdrawn-text text-sm"
                  />
                  {uploadedImage1 && (
                    <p className="text-black text-sm mt-2 handdrawn-text">✓ {uploadedImage1.name}</p>
                  )}
                  {error1 && (
                    <p className="text-red-600 text-sm mt-2 handdrawn-text">error: {error1}</p>
                  )}
                </div>
                ...
                <button
                  ...
                  className="w-full handdrawn-button text-black bg-white px-6 py-3 hover:bg-black hover:text-white handdrawn-text text-sm uppercase tracking-wider transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isGenerating1 ? (
                    <>
                ...
                {generatedMeme1 && (
                  <div className="mt-4">
                    ...
                    <a
                      ...
                      className="mt-2 w-full handdrawn-button text-black bg-white px-4 py-2 hover:bg-black hover:text-white handdrawn-text text-sm uppercase tracking-wider transition-all duration-200 flex items-center justify-center gap-2"
                    >
            ...
            <div className="handdrawn-border handdrawn-box p-6 bg-white">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-black handdrawn-text text-lg">{">"}</span>
                <h3 className="text-black handdrawn-text text-lg uppercase tracking-wider">download template</h3>
              </div>
              
              <p className="text-gray-700 mb-6 text-sm handdrawn-text">get the original job application template!</p>
              
              <div className="space-y-4">
                <div className="handdrawn-border p-4 mb-4 bg-gray-100">
                  <img 
                ...
                <a
                  ...
                  className="w-full handdrawn-button text-black bg-white px-6 py-3 hover:bg-black hover:text-white handdrawn-text text-sm uppercase tracking-wider transition-all duration-200 flex items-center justify-center gap-2"
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-16">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="handdrawn-button border-white text-white bg-black px-12 py-4 hover:bg-white hover:text-black handdrawn-text text-lg uppercase tracking-wider transition-colors duration-200 inline-block"
            >
